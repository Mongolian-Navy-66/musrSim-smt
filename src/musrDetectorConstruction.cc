...
G4VPhysicalVolume* musrDetectorConstruction::Construct()  {
  ...
  while (!feof(fSteeringFile)) {
	...
	cout << "landauSigma = " << musrMuEnergyLossLandau::landauSigma << endl;
      ...
      else if (strcmp(tmpString1, "VisualizeEvent") == 0) {} // Exception for visualize specific event
      else if (strcmp(tmpString1, "rootEventSelector") == 0) {} // Exception for event selector
